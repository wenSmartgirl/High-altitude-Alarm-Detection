...
/* 编译日期和时间 */
#define BUILD_DATETIME     "2025-11-14 07:01:42"
...
#define MODEL_PREFIX        cah
#define NCNN_PARAM_ID_SPACE cah_ncnn_param_id
#define NCNN_PARAM_MEM      cah_ncnn_param_bin /* ncnn_param_bin */
#define NCNN_BIN_MEM        cah_ncnn_bin /* ncnn_bin */
